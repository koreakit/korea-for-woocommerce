...
wp-env run tests-cli "wp core update --quiet"
...
wp-env run tests-cli "wp option set woocommerce_store_address '123 Maple Street'"
wp-env run tests-cli "wp option set woocommerce_store_city 'Seoul'"
wp-env run tests-cli "wp option set woocommerce_default_country 'KR'"
wp-env run tests-cli "wp option set woocommerce_store_postcode '12345'"
wp-env run tests-cli "wp option set woocommerce_currency 'KRW'"
...
wp-env run tests-cli "wp plugin activate korea-for-woocommerce"
