...
cli wp core install --path=/var/www/html --url=localhost:8082 --title="Korea for WooCommerce" --admin_name=admin --admin_password=admin --admin_email=admin@example.com --skip-email
...
cli wp option set woocommerce_currency "KRW"
...
cli wp plugin activate korea-for-woocommerce
