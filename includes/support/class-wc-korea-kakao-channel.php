...
class WC_Korea_Kakao_Channel {
	...
	public function __construct() {
		...
		// Hook Product Page
		if ( ! empty($this->settings['kakaochannel_productpage']) ) {
			add_action('woocommerce_'. $this->settings['kakaochannel_productpage'], array($this, 'display_button'));
		}

		// Hook Thank You Page
		if ( ! empty($this->settings['kakaochannel_thankyoupage']) ) {
			add_action('woocommerce_'. $this->settings['kakaochannel_thankyoupage'], array($this, 'display_button'));
		}
