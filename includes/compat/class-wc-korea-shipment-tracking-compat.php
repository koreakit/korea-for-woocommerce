...
class WC_Korea_Shipment_Tracking {

	public function __construct() {
		add_action( 'wc_shipment_tracking_get_providers' , array( $this, 'wc_shipment_tracking_kr_providers' ) );
	}

	public function wc_shipment_tracking_kr_providers( $providers ) {
...
new WC_Korea_Shipment_Tracking();